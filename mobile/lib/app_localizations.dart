...
class AppStrings {
  ...
  static const _english = <String, String>{
    ...
    '上传视频并查看可解释报告': 'Upload a video for an explainable report',
    ...
    '原始视频': 'Original video',
    '骨骼标注视频': 'Pose overlay video',
    '返回骨骼标注视频': 'Return pose overlay video',
    '拍摄机位': 'Camera angle',
    '选择识别动作': 'Choose exercise',
    '这里只显示服务端当前已支持的动作': 'Only server-supported exercises are shown',
    '视频、骨骼标注与 AI 评价': 'Video, pose overlay and AI review',
    '个性化': 'Personalization',
    '默认休息': 'Default rest',
