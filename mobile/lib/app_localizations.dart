...
class AppStrings {
  ...
  static const _english = <String, String>{
    ...
    '训练场、探索与匿名互动': 'Gym, exploration and anonymous interactions',
    '训练场': 'Gym',
    '探索': 'Explore',
    '同场训练者': 'Training here now',
    '允许同场匿名展示': 'Show my anonymous gym status',
    '允许陌生用户碰拳': 'Allow fist bumps',
    '允许陌生用户加油': 'Allow cheers',
    '角色与外观': 'Character & appearance',
    '训练者升级': 'Athlete level up',
    '本次成长': 'Workout growth',
    '探索收藏': 'Exploration collection',
    '记录': 'History',
    '动作识别': 'Form Check',
    'AI': 'AI',
    'AI 对话': 'AI Chat',
