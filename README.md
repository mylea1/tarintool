...
- Flutter 主应用使用五个一级入口：主页、训练、世界、AI、我的；动作库与记录保留在“训练”内，识别保留在 AI 内
...
- 角色成长：按自身历史力量进步、PR、计划完成与一致性结算训练者等级和肌群等级；空训练与重复结算不会获得奖励
- 世界：用户主动选择场馆代号后才匿名展示，同场只允许碰拳、加油和挑战；每日探索与训练等级相互独立，不上传精确位置、不生成虚假在线用户
